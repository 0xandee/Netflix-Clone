...
import { updateMovieView } from '../../services/api/movie';
        ...
        <div className="position-relative px-4">
            <Row lg='9' sm='12' className=" PreviewButton__container PreviewButton__float-left-container">
                ...
                <Col sm='4' className="d-flex justify-content-between mx-4">
                    ...
                    <div id="likeIcon" >
                        <div className="PlayButton__secondary-color PlayButton__secondary-button w-100">
                            <div className="PlayIcon_icon-container">
                                <div className="AddIcon_icon">
                    ...
                    <div id="dislikeIcon" >
                        <div className="PlayButton__secondary-color PlayButton__secondary-button">
                            <div className="PlayIcon_icon-container">
                                <div className="AddIcon_icon">
