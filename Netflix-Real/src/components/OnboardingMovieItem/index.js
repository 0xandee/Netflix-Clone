...
const OnboardingMovieItem = (props) => {
    ...
    return (
        <div id='onboardingMovies'>
            <div className={`${isCheck ? 'selected' : 'not-selected'} box w-100`} style={{height:'500px', maxHeight:'500px' }} value={props.id} onClick={movieChecked}>
                <img className="art h-100 w-100" src={props.artLink} alt="art" />
