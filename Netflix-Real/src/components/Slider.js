...
const Slider = () => {
    return (
            ...
            <section className="thumbSection mb-3">
                ...
                "1024": {
                    ...
                    <SwiperSlide className="swiper-slide">
                        <a class="thumbTile" href="#">
                            <img class="thumbTile__image"
                                src="https://occ-0-395-325.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABfLAjCBCg_jXfT6k54BtGLN7f7MaJdmJk7qGd52AToHK6mAp7o0chUwh6WhEl4HDQFV1L2ZT17ICl4wxH59r5YeLofE.jpg?r=13e"
                                alt="The Queen's Gambit"/>
                        </a>
                        <div className="controlPlayer pl-4em">
                            <div className="PreviewButton__container_preview PreviewButton__hidden-container">
        ...
        <div className="">
            <section className="thumbSection mb-3">
                <h2 class="thumbTitle">Trending Now</h2>
                <Swiper spaceBetween={5}
                slidesPerView={3}
                loop={true}
                freeMode={true}
